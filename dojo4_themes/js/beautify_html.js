...
---------------
  ...
  Modified for ExpressionEngine by Justin Crawford (@hoosteeno)
...
//Wrapper function to invoke all the necessary constructors and deal with the output.
  ...
  function Parser() {
    ...
    this.get_content = function () { //function to capture regular content between tags
      ...
      while (this.input.charAt(this.pos) !== '<' && this.input.charAt(this.pos) !== '{') {
    ...
    this.get_tag = function () { //function to get a full tag and parse its type
      ...
      do {
        ...
        this.tag_closer = this.Utils.tag_closers[content[0]] || '>';
        ...
        if (content.length && content[content.length-1] !== '=' && input_char !== this.tag_closer
      ...
      //} while (input_char !== '>');
      } while (input_char !== this.tag_closer);
      ...
      if (tag_complete.indexOf(' ') != -1) { //if there's whitespace, thats where the tag name ends
        ...
        tag_index = tag_complete.indexOf(this.tag_closer);
      }
      ...
      if (tag_complete.charAt(tag_complete.length-2) === '/' ||
      ...
      else if (tag_complete.match(/^{embed/)) { 
        this.tag_type = 'SINGLE';
      }
        ...
        if (tag_check.indexOf('[if') != -1) { //peek for <!--[if conditional comment
          if (tag_complete.indexOf('!IE') != -1) { //this type needs a closing --> so...
            var comment = this.get_unformatted('--'+this.tag_closer, tag_complete); //...delegate to get_unformatted
            content.push(comment);
          }
          this.tag_type = 'START';
        }
          ...
          var comment = this.get_unformatted('--'+this.tag_closer, tag_complete);
          content.push(comment);
          this.tag_type = 'SINGLE';
        }
      }
